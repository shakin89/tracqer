...
class DataDocumento( models.Model ):
    ...
    def __unicode__( self ):
        return "Data: %s - Firma: %s" % ( self.data_firma.strftime( "%d/%M/%Y" ), self.tipo_firma )
...
class Documento( models.Model ):
    ...
    data = models.ForeignKey( DataDocumento )
    ...
    # IMPORTI
    #-------------------------------------------------------     
    importo_base = models.ForeignKey( ImportoDocumento, related_name="importo_base" )
    importo_aggiudicazione = models.ForeignKey( ImportoDocumento, related_name="importo_aggiudicazione" )
    ...
    # ASSEGNATARI
    #-------------------------------------------------------     
    assegnazione = models.ForeignKey( AssegnazioneDocumento )
    
    #------------------------------------------------------- 
    # TRACKING FIRME
    #-------------------------------------------------------     
    firma = models.ForeignKey( FirmaDocumento )
    

    def __unicode__( self ):
        return "Doc: %s numero %d" % ( self.tipo_documento.sigla, self.numero )
